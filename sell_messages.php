	...
	<header class="header-v4">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="sell_messages.html">Messages</a>
				</li>
			</ul>
		</div>
	...
	<section class="bg0 p-t-104 p-b-116">
		...
		<div class="container">
			...
			<div class="p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
				...
				<form  action="PHP/add_item_pic.php" method="POST" enctype="multipart/form-data">
					<table class="table" style="width:100%; margin: auto;">
					  	<tr class="bor8 m-b-20 how-pos4-parent stext-111">
                            <th class="cl2 plh3 p-l-62 p-r-30">Username</th>
                            <th class="cl2 plh3 p-l-62 p-r-30">Date</th>
                            <th class="cl2 plh3 p-l-62 p-r-30">Time</th>
					    	<th class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30">Message</th>
					  	</tr>
                        <?php 
                        $productByCode = $db_handle->runQuery("SELECT * FROM messages");
                        foreach($productByCode as $kmm ) {
                            echo "<tr class='bor8 m-b-20 how-pos4-parent stext-111'>";
                            echo "<td class='p-l-62 p-r-30'>" . $kmm['email'] ."</td>";
                            echo "<td class='p-l-62 p-r-30'>" . $kmm['date'] ."</td>";
                            echo "<td class='p-l-62 p-r-30'>" . $kmm['time'] ."</td>";
                            echo "<td class='stext-111 cl2 plh3 size-116 p-l-62 p-r-30'><label>" . $kmm['message'] ."</label></td>";
                            echo "</tr>";
                        }
                        ?>
					</table>
