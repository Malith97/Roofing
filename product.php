		...
		<div class="container">
			...
			<div class="row isotope-grid" id="product-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<form method="post" action="product.php?action=add&product_code=<?php echo $product_array[$key]["product_code"]; ?>">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<p class="stext-102 cl3 p-t-23">
								Perfect fir for classical homes. Sunlight reflecting technique and keep cool inside
							</p>
