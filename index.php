...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode[0]["product_code"]=>array('product_name'=>$productByCode[0]["product_name"], 'product_code'=>$productByCode[0]["product_code"], 'product_weight'=>$productByCode[0]["product_weight"], 'quantity'=>$_POST["quantity"], 'product_price'=>$productByCode[0]["product_price"]));
	...
	<header id="header">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="shopping_cart.php" class="label1 rs1" data-label1="hot">Cart</a>
				</li>
		...
		<div class="container">
			...
			<div class="row isotope-grid" id="product-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<form method="post" action="index.php?action=add&product_code=<?php echo $product_array[$key]["product_code"]; ?>">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $product_array[$key]["product_image"]; ?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								<span class="stext-105 cl3">
									Rs.<?php echo "$".$product_array[$key]["product_price"]; ?>
								</span>
							...
							<div class="block2-txt-child2 flex-r p-t-3">
                                ...
                                <button type="submit" name="add" value="Add to cart" class="btn btn-success stext-103">Add Cart</button>
                            </div>
						</div>
						</form>
					</div>
