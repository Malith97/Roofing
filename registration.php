...
<!--===============================================================================================-->
	<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Open+Sans'><link rel="stylesheet" href="css/style_login.css">
                ...
                <div class="signup-form">
                    ...
                    <form action="php/registration.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="com_email" placeholder="Email"/>
                        </div>
                        <div class="form-group">
                            <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                            <input type="text" name="com_contact" placeholder="Contact Number" required />
                        </div>
                        <div class="form-group">
                            <label for="pass"><i class="zmdi zmdi-lock-outline"></i></label>
                            <input type="password" name="com_password" placeholder="Password"/>
                        </div>
                        <div class="form-group">
